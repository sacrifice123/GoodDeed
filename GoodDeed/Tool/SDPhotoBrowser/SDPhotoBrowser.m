...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self.backgroundColor = [UIColor blackColor];//SDPhotoBrowserBackgrounColor;
    }
    return self;
}
...
- (void)setupToolbars//暂时不用，有多张图片时使用
{
//    // 1. 序标
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer//单击
{ NSLog(@"单击");
...
- (void)imageViewDoubleTaped:(UITapGestureRecognizer *)recognizer//双击
{ NSLog(@"双击");
